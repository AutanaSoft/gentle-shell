...
test("Gentle Shell v3.5.1 package and runtime stop before publication", () => {
	const packageJson = readPackageJson();
	assert.equal(packageJson.version, "3.5.1", "the release manifest must remain explicitly pinned to v3.5.1");
	assert.equal(

...
T1 and T2 committed with relevant focused checks. T3 delivery and target CI pending. Cumulative range is medium and under the native review budget from `842301779`; no committed-range review due yet. Mirror topic: `odd/odd-phase-prompt-reliability/tasks`.
